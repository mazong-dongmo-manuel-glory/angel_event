<template>
  <div class="home-page">
    ...
    <!-- Image + Quote Section (Parallax feel) -->
...
.hero-image-container {
  position: absolute;
  inset: 0;
  opacity: 0.8; /* Slightly darkened for text contrast */
}
...
.widget-icon {
  color: var(--color-gold); /* Keep gold accent ONLY on icons for luxury touch */
  width: 48px;
  height: 48px;
  margin: 0 auto var(--spacing-lg);
}
